...
function fft(x::StridedVector{Complex{T}}) where {T<:Union{Float32,Float64}}
    n = length(x)
...
function bfft(x::StridedVector{Complex{T}}) where {T<:Union{Float32,Float64}}
    n = length(x)
...
ifft(x::StridedVector{Complex{T}}) where {T<:Union{Float32,Float64}} = bfft(x) ./ length(x)
...
function rfft(x::StridedVector{T}) where {T<:Union{Float32,Float64}}
    n = length(x)
